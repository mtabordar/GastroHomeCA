using GastroHomeCA.Domain.Events;
using Microsoft.Extensions.Logging;

namespace GastroHomeCA.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("GastroHomeCA Domain Event: {DomainEvent}", notification.GetType().Name);
